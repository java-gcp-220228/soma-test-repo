...
public class ExceptionController implements Controller{
   ...
   private ExceptionHandler AcctNotFound = (e, ctx) -> {
        logger.warn("User attempted to retrieve a account that was not found. Exception message is " + e.getMessage());
        ctx.status(404);
        ctx.json(e.getMessage());};
        ...
        public void mapEndpoints(Javalin app) {
          ...
          app.exception(AcctNotFoundException.class, AcctNotFound);
